 ...
 */
public class ByLinktextFinder implements IFinder, IConfigurable{

    private Map<String, String> properties = new HashMap<String, String>();
    public static final String KEYWORD = "id";
    
    public ByLinktextFinder(){
        setDefaults();
    }
    
    public ByLinktextFinder(String id){
        setDefaults();
    ...
    public WebElement findElement(WebDriver driver) {
        return driver.findElement(By.linkText(properties.get(KEYWORD)));
    }
