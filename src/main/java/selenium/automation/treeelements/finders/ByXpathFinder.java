 ...
 */
public class ByXpathFinder implements IFinder, IConfigurable{

    private Map<String, String> properties = new HashMap<String, String>();
    public static final String KEYWORD = "id";
    
    public ByXpathFinder(){
        setDefaults();
    }
    
    public ByXpathFinder(String id){
        setDefaults();
    ...
    public WebElement findElement(WebDriver driver) {
        return driver.findElement(By.xpath(properties.get(KEYWORD)));
    }
